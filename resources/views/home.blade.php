        ...
        <div class="card-body">
            <form method="post" action="{{ route('data.update') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input id="datepicker" type="date" name="register_date" width="300" value="{{ $data->Register_date }}" />
                ...
                <div class="form-group">
                    ...
                    <input id="datepicker2" type="date" name="Certificate_date1" width="300" value="{{ $data->Certificate_date1 }}" />
                ...
                <div class="form-group">
                    ...
                    <input id="datepicker3" type="date" name="Certificate_date2" width="300" value="{{ $data->Certificate_date2 }}" />
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="vdo" class="form-control" id="youTubeUrl" value="{{ $data->Vdo }}" >
                </div>

                <div class="form-group">
                    <a href="https://www.youtube.com/watch?time_continue=322&v=C1qT0TslTNo&feature=emb_title">หาค่า Latitude(ละติจูด),Latitude(ละติจูด) </a> <br>
                    <label for="exampleFormControlSelect1">ละติจูด</label>
                    <input class="form-control" name="lat" id="lat" type="text" value="{{ $data->Latitude }}" readonly>
                </div>

                <div class="form-group">
                    <label for="exampleFormControlSelect1">ลองจิจูด</label>
                    <input class="form-control" name="lng" id="lng" type="text" value="{{ $data->Longitude }}" readonly>
                </div>
